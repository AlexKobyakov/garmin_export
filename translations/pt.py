...
translations = {
    ...
    'tool_invalid': 'distribuição incompleta ou inválida (JAR + lib/ necessários)',
    ...
    'tags': 'Tags',
    'metadata_details': 'Metadados',
    'qgis_support': 'Compatibilidade QGIS',
    'processing_provider': 'Provedor Processing',
