...
translations = {
    ...
    'tool_invalid': 'Distribution ist unvollständig oder ungültig (JAR + lib/ erforderlich)',
    ...
    'tags': 'Tags',
    'metadata_details': 'Metadaten',
    'qgis_support': 'QGIS-Unterstützung',
    'processing_provider': 'Processing-Anbieter',
